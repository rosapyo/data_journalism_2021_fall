...
The address is 126 E Burke St
There are 6 loans. 
The name of the business is The Hub Community Workspace. 
...
wv_clean_zip_25401 <- read_csv("data/zip_25401_loan_sample-csv.csv")
...
Yes, it does seem suspicious as ABRAHAM ASHTON is mentioned in several businesses entities in their ownership such as HUB Co-op, Ronin Properties. 
...
**A3.** Martinsburg has the highest number of loans.
THe industry title they had more than any other title is 
...
**A4.** 
My hypothesis is even though many of the businesses that needed loans were small businesses like mom and pop shop restaurants, there were fraudulent full-service restaurants to get loans as seen in investigating these restaurants did not have actual addresses.
...
**A5.** Cottle Christi L LLC had the highest approved loan amount for 280434 on Feburary 17, 2021 and helped retain 94 jobs. There is a difference in the business name as customers know the restaurant as "Kitzie's Cafe" with 6 locations. The location "Kitzie's Restaurant & Lounge" in Rockville Cliff Drive closed during the pandemic before the loan approval. 
