...
**A4** [I think the country with the most loans is more of a city environment therefore has more business and people compared to the county with the least loans]
...
**A5** [GREENBRIAR HOTEL CORPORATION for $8,912,202. The business is a corporation and retained 500 jobs.]
...
**A6** [West Virginia Governor Jim Justice, ]
...
**A7** [The average loan amount is $77,338.08]
```{r}
wv_ppp_loans %>%
  group_by(state) %>%
  summarise(
...
**A8** [Calhoun County has 63 loans but has the highest mean loan amount.The difference between the minimum loan amount and the maximum loan amount is 2565878.]
```{r}
wv_ppp_loans %>%
  group_by(project_county_name) %>%
  summarise(
