...
**Answer**The dataframe has 152,584 different tweets from different politicians with their usernames, the tweet, the branch, state, district, and title. 
...
**Answer** The function took out all the words used from the a_list_of_words value and added "Dog", "dog", "dog", "cat", "cat", ","
...
**Answer** A list of over 5 million words were extracted from the tweets. 
...
**Answer**Showed the top 25 words which i made me reflect on my most used words. 
...
**Answer** "stop words" were removed so we can see what the most other common words of meaning are. The top one was covid which made a lot of sense for me, especially from politicians
...
**Answer** The results were the top ten words for 2020 and 2021. The results were similar ceeentering around covid. 
...
**Task** Run the following code and describe the results.
**Answer** The reesults showed two word phrases in 2020 which were covid 19. 
...
**Task** Run the following code and describe the results.
**Answer** The results were oncee again covid 19 but a two percent increase in how many times it was mentioned in tweets. 
...
**Task** Run the following code and describe the results.
**Answer** Both parties used the two word phrase covid 19 but democrats used terms like social distancing and town halls while republicans used americaan people and caare act. 
...
**Task** Run the following code and describe the results.
**Answer** Republican house candidates used the two word phrases "president trump" and "god bless" in 2020. In 2021 theey used the phrases "covid vaccine," "covid positive" and "vaccine mandates.
...
**Answer** Sentiments that seem counter intuitive is that some words are negative my definition like "virus" but can be used in a positive way like "stopping the virus." Words work alongside the words around them to creat whether the meaning is positive or negative. 
