...
**Answer** The data frame shows when a vaccine was administered by time and date and where (county) 
...
**Answer**
The dataframe make vaccination date na. 
...
**Answer** The tibble shows tottal vaccine per county I think. 
...
**Answer**The dataframe shows the number of people vaccinated in Prince George's county  every day.The pattern can be that in the first couple of days there arent as many people fully vaccianted. 
...
**Answer**More people got vaccinated in the spring of 2021 and sincee then there was beeen a decrease in people getting vaccinated. 
...
**Answer** Between June 2020 and july 2021 (almost a year) there has been an increase in cases
...
**Task** Run the following code and describe what the resulting chart shows
**Answer** The new chart acrturaly chaarts the increase new cases
...
**Answer**The map shows the number of covid cases in color in each county as of 12/13/2021.
