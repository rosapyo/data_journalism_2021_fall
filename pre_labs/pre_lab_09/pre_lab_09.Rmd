...
**Answer** Takes the data from maryland_ppp_top_counties and group it by county names so only those appear and then takes the total loans and arrange them by low to high and then shows the ttop ten results.
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer**
There is a bar chart by project_county_name and count. 
...
**Answer** This has listed the bars by lowest to highest amount of counts.
...
**Answer** The x and y axis is switched.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** This has a minimal theme.
...
**Answer** Used the theme of the economist
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** Titles the graph, places an x and y axis with a caption. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** a graph tthat shows date apprived and total loans
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** Made a bar graph of the chart above
...
**Answer**The x and y axis flipped on the line graph
```{r}
ppp_maryland_loans_by_date %>%
  ggplot() + 
  geom_line(aes(x=date_approved, y=total_loans)) + 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**The angle for the x axis moved 45 degrees.
```{r}
ppp_maryland_loans_by_date %>%
  ggplot() + 
  geom_line(aes(x=date_approved, y=total_loans)) + 
