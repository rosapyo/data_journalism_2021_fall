...
**Answer**A list of industry classifications and an overview of them all.
...
**Answer** html list of head and body
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** shows elements of the code and the style along with other things such as layoutt
...
**Answer**a table of the positions and possible values
...
**Answer** shows a table that shows the sector 
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** table showing the sector and description
...
**Answer** list of the sectors in an unorganized way
...
**Answer** It shows the sector and a description
...
**Answer** graph showing the sectors and descriptions 
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**the website talks about utility sectors, workforce statistics, and earnings 
...
**Answer** an html code that find the element id of iag22emp1
...
**Answer** the html code is in a code block called employment info
...
**Answer**Takes all employment and counts in the month of june 2021
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** Mining, Quarrying, and Oil and Gas Extraction
...
**Answer**list of the sectors below in a list
```{r}
...
**Answer** red in for (sector in sector_list) {
  print(sector)
...
**Answer** table with the sector and the description 
...
**Answer**
lists the number of employment in tthe month of june 2021 as 586.7
```{r}
...
**Task** Run the following code to load table from last chapter. Briefly describe the output that appears below the codeblock.
**Answer** table 20 by 2 with the secotr and and descripiton cleaned with standardied column headers
```{r}
# Define url of page we want to scrape
...
**Answer** table with sector, description, and url
...
**Answer** table with sector, description, sector path id, and url
...
**Answer** table with sector, description, id, and url but 19 by 4
...
**Answer** sector, id, description, urlin 1 by 4
...
**Answer** row number with associated url 
```{r}
...
**Answer** 10 by 6 data frame with data series and dates 
...
**Answer** 1 by 6 graph with data series, backlog, and dates
...
**Answer** Data series of all employment in several months with the sector and description
...
**Task** Run the following for loop to clean up tables. Briefly describe the output that appears below the codeblock.
**Answer** a 1 by 3 graph with sector, june employment and description
...
**Answer** a 19 by 3 with sector, description and june employemnt
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** workforce statistics and graph on employment
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** workforce statistics on unemployment
...
**Answer**agriculture is there, is it supposed to? 
1 19 by 3 graph with sector, description, and june employment 
