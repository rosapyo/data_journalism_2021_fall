...
**Answer** It isnt done by how big they are and also there are groups that need to be grouped together
...
**Answer** It made all the zipcodes 5 digits and made all the cities the same name if there were mispells
...
**Answer** kept it in three columns, madee the names ungrouped
...
**Task** Follow the directions in the textbook to upload ppp_loans_md.csv.zip to Open Refine. Follow the instructions to clean as many cities as the Open Refine clustering tool can identify.  In class, I will come around to look at the Open Refine project you created to do this. okat
