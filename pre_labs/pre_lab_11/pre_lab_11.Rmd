...
**Answer**
I see a list of files labeled hospital with different file ttypes.
...
**Answer**
A long list dictating the layers of the hospital
```{r}
...
**Answer**Goes through the listt of hospital and sorts for only maryland ones with their names and addresses.
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Sorts the hospital by the kind they are. 
```{r}
md_hospitals %>%
  group_by(TYPE) %>%
  summarise(
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**Shows thee hospitals that are general acute care with their id, name, and address
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** maps on a grid with the longitide and latitude where marylaand hospitals are
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The output is 3233 rows and 18 columns 
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**A chart with 24 obs and 18 var that took the Maryland FP number and only allowed counties sttartung with 24 to be included. 
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Shows thee state of maryland with county boundaries.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The previous map is laayered with the hospital pin points to show where these hospitals are located. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The dots on the map now indicate how large thee hospitals are by the color of the dots. 
...
**Answer** Attaching package: ‘tidycensus’
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Gives a chart with hospitals in maryland thaat are acute care hospitals
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A chart with the number of beds in each county
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Error: Your API call has errors. The API message returned is Sorry, the system is currently undergoing maintenance or is busy. Please try again later..

BUT i assume it shows the county and the population data for each county in maryland
...
I ASSUME population data us added in 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Error: object 'md_county_population' not found because Error: Your API call has errors. The API message returned is Sorry, the system is currently undergoing maintenance or is busy. Please try again later..
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** because api is down, I assume they clean the data by renaming county as name as well as population as estimate. Theree is the removal of COUNTY,", Maryland|County". 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Because api isnt working, I assume the two join
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**because the way the program is counting bed, wee havee to convert tthe value to 0
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** To simplify the data they calculate the number of beds by 100,000. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** I ASSUME that this graphs eeach county with the colors that show how many beds per 100,000. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**This changes the color scale so it is easier to read
...
**Answer**the color scale is changed to a log scale to see better. 
